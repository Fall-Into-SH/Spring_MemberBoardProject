	...
	<section id="hero" style="padding-top: 50px;">
		<div class="container position-relative text-center text-lg-start"
			...
			<div class="row">
				...
				<form action="boVideo" method="post" enctype="multipart/form-data">

					<div class="member" style="color: white;">
						<br /> <br /> <br /> <br /> <br /> <br /> <br />


						<div class="field">
							<b>제목</b> <input type="text" name="boTitle">
						</div>
						<div class="field">
							<b>유튜브 주소</b> <input type="text" name="boUrl">
						</div>
						<div class="field">
							<b>썸네일</b> <input type="file" name="boFile" />
						</div>

						<!-- 6. 생성하기 -->
						<input style="background-color: orange; color: white"
