		...
		<div class="member">
			...
			<form action="mModify" method="post" name="modifyForm"
				...
				<div class="field" style="background: #d8d8ff;">
					<ul>
						<li style="display: inline-block;">
							<h3 class="logintext">아이디 : &nbsp;&nbsp;&nbsp;</h3> <input
							type="hidden" name="memId" value="${modify.memId}" /> <input
							type="hidden" name="DFileName" value="${modify.DFileName}" /> <input
							type="hidden" name="memEmail" value="${modify.memEmail}" />
						</li>
						<li style="display: inline-block;">
					...
					<ul>
						<li style="display: inline-block;">
							<h3 class="logintext">비밀번호
								:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
						</li>
						<li style="display: inline-block;"><input type="password"
							name="memPw" id="memPw" onkeyup="pwRegexp()" /> <br /> <span
							id="pwResult1"></span></li>
					</ul>
					<ul>
						<li style="display: inline-block;">
							<h3 class="logintext">비밀번호 확인:</h3>
						</li>
						<li style="display: inline-block;"><input type="password"
							id="checkPw" onkeyup="pwCheck()" /> <br /> <span id="pwResult2"></span></li>
					</ul>
				...
				<div class="field" style="text-align: center;">
					<input type="button" value="정보수정" onclick="checkConFirm()">
				</div>
			</form>
		</div>
	</c:if>
...
<c:choose>
	...
	<c:when test="test=${loginId eq null}">
		<script>
		alert("로그인후 사용하세요");
