...
<body>
	...
	<section id="hero" style="padding-top: 50px;">
		<div class="container position-relative text-center text-lg-start"
			...
			<div class="row">
				<c:choose>
					<c:when test="${boMode == 'all'}">
						<h2 class="text">게시글 목록</h2>
						<div style="size: 30px">
							<ul style="float: right;">
								<li style="display: inline-block;"><a href="boWriteForm"
									class="book-a-table-btn scrollto d-none d-lg-flex">게시글 작성</a></li>
							</ul>
						</div>
